      ...
      <section className="mission-section">
        <div className="mission-card">
          ...
          <p className="mission-text">
            Welcome to your journey. Every day is a new quest where you become your best self, not alone,
            but alongside your teammates. Through Side Quests, you embark on challenges that matter, track
            your victories, and celebrate wins together. This is more than habit tracking; it&apos;s a quest for
            growth, accountability, and triumph.
          </p>
        </div>
      </section>
